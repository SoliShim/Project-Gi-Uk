...
var pdfAssetPath = (fileName) => assetPath(`pdf-extracted/${fileName}`);
...
var marketRows = [
	...
	[
		"초고령화 가속",
		"2025년 65세 이상 20.3%, 2070년 46.4% 전망",
		"기억 보존 니즈가 특정 세대가 아닌 보편적 생활 문제로 확장됩니다."
	],
	[
		"시장 기회",
		"상조·선불식 할부 시장 선수금 10.3조 원 규모",
		"기존 장례·요양·실버 산업의 디지털 전환 수요를 흡수할 수 있습니다."
	]
];
var marketStats = [
	{
...
var benchmarkRows = [
	...
	[
		...
		"B2B 인터랙티브 영상",
		"기관용 질의응답 경험",
		"개인 가족의 장기 데이터 인프라와는 거리",
		sources.storyfile
	],
	[
		"Project Gi-Uk",
		"Medium-Agnostic 아카이브",
		"텍스트·음성·사진·3D 데이터를 통합 보관",
		"XR/MR 확장 시 재가공 없이 연결 가능한 Future-proof 구조",
		"#system"
	]
];
var revenueStreams = [
	[
		"Acquisition",
		"B2C 초기 구축",
		"인터뷰 큐레이션, 가족 자료 정리, 스마트폰 다각도 촬영, 스튜디오/출장 기록 패키지"
	],
	[
		"Retention",
		"B2C 구독",
		"AES-256 암호화 보관, 기념일 타임캡슐, 가족 초대, 데이터 업데이트와 내보내기"
	],
	[
		"Scaling",
		"B2B 제휴",
		"상조, 실버타운, 요양기관, 추모공원 대상 라이선스와 API 연동 수익"
	]
];
var businessLevers = [
	[
		"초기 객단가",
		"기록 구축 패키지",
		"인터뷰·자료 정리·촬영을 묶어 1회성 매출을 만듭니다."
	],
	[
		"반복 매출",
		"Family Vault 구독",
		"보관, 권한, 알림, 내보내기 기능이 장기 구독의 이유가 됩니다."
	],
	[
		"채널 확장",
		"기관 라이선스",
		"상조·실버타운·요양기관의 기존 고객 접점을 활용합니다."
	],
	[
		"전환 비용",
		"원천 데이터 락인",
		"가족 서사, 음성, 3D 데이터가 쌓일수록 이탈 비용이 커집니다."
	]
];
var archiveBoxes = [
	{
...
var pipelineRows = [
	[
		"3D Rendering",
		"Multi-view JPG → NeRF volumetric synthesis → 3D Gaussian Splatting",
		"Three.js .splat 모바일 렌더러, 60fps 목표"
	],
	[
		"Voice Modeling",
		"고품질 회상 인터뷰 → Whisper STT → few-shot TTS 검증",
		"VALL-E 계열 TTS, 합성 음성 워터마크"
	],
	[
		"Narrative RAG",
		"전사문 정제 → 가족 질문 태깅 → pgvector 임베딩",
		"검증된 답변 범위 안에서 검색·요약"
	],
	[
		"Legacy Release",
		"release_date + family_admin_confirmed + audit log",
		"타임캡슐 잠금 해제와 접근 기록"
	]
];
var schemaRows = [
	[
		"User_Intent",
		"user_id, consent_status, data_retention_period, access_log_id",
		"consent_status = TRUE일 때만 AI 생성 파이프라인 허용"
	],
	[
		"Time_Capsule",
		"capsule_id, trigger_event, recipient_ids, is_locked",
		"release_date와 가족 관리자 확인 조건 충족 시 unlock"
	],
	[
		"Access_Log",
		"actor_id, action_type, resource_id, timestamp, device_hash",
		"모든 열람·다운로드·삭제 요청을 감사 로그로 기록"
	]
];
var ethics = [
...
var roadmap = [
	[
		"MVP",
		"2025 하반기",
		"기록 수집, STT 전사, 가족 권한, 암호화 보관"
	],
	[
		"검증형 AI",
		"2026",
		"서사 RAG, 제한형 대화, AI 라벨·워터마크"
	],
	[
		"입체 초상",
		"2026-2027",
		"스튜디오 촬영, NeRF/3DGS 렌더링, 모바일 최적화"
	],
	[
		"B2B 확장",
		"2027-",
		"상조·요양·실버타운 API와 기관 콘솔"
	]
];
function App() {
	const [consentMode, setConsentMode] = (0, import_react.useState)("가족 공유");
	const [selectedVisual, setSelectedVisual] = (0, import_react.useState)(null);
	const [activeSection, setActiveSection] = (0, import_react.useState)("vision");
	(0, import_react.useEffect)(() => {
		const sections = Object.keys(sectionNavMap).map((id) => document.getElementById(id)).filter(Boolean);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, { activeSection }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "hero-copy",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "프로젝트 기억" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "hero-lead",
								children: "사랑하는 이의 오늘을 가족의 기억 인프라로 남깁니다."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "hero-sub",
								children: "Project Gi-Uk은 사진, 목소리, 3D 외형, 생애 서사를 생전 동의 기반으로 수집하고 AI로 정리해 다음 세대까지 보존하는 패밀리 아카이브입니다."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									"Premortem Intent",
									"Medium-Agnostic Data",
									"Zero-Trust Archive",
									"XR/MR Future-ready"
								].map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									href: "#market",
									children: ["시장 기회 보기 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { size: 18 })]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									className: "secondary-action",
									href: "#system",
									children: ["아키텍처 보기 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { size: 17 })]
								})]
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductMockup, {})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "strategy band",
				id: "vision",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: strategyPillars.map((pillar) => {
							const Icon = pillar.icon;
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "strategy-card",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 24 }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "UX의 온기" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "가족이 실제로 기록하고 다시 꺼내볼 수 있는 인터페이스" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "아키텍처의 신뢰" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Premortem Intent, Zero-Trust, Audit Log가 결합된 안전 구조" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(VisualEvidenceRail, {
						items: sourceScenes,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: marketStats.map((stat) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: stat.label }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "donut-chart",
									"aria-label": `${stat.label} 구성 차트`,
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "donut-ring",
										style: { background: donutGradient(stat.segments) },
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: stat.center })
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "donut-legend",
										children: stat.segments.map((segment) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { style: { background: segment.color } }), segment.label] }, segment.label))
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									target: "_blank",
									rel: "noreferrer",
									children: ["출처", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, {
										size: 14,
										strokeWidth: 2.5
									})]
								})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WebImageFeature, { items: [webVisuals[0], webVisuals[1]] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: benchmarkRows.map(([name, model, strength, limit, href]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: strength }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: limit })
							]
						}, name))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "advantage-panel",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Network, { size: 24 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Project Gi-Uk의 경쟁 우위: Medium-Agnostic Archive" })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "특정 결과물에 묶이지 않고 텍스트, 음성, 사진, 영상, 3D 원천 데이터를 각각 보관합니다. 그래서 오늘은 모바일 웹 아카이브로, 이후에는 XR/MR 초상과 인터랙티브 전시로 확장할 수 있습니다." })]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							...
							children: archiveBoxes.map((box) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: box.subtitle }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: box.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: item }, item)) })
									]
								}, box.title);
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "archive-visual-stack",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductMockup, {})
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "archive-evidence",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VisualCard, {
							item: productScenes[0],
							onOpen: setSelectedVisual,
							wide: true
						})
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 24 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: stage.stage })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: stage.title }),
									stage.items.map(([title, text]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mini-spec",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text })]
									}, title))
								]
							}, stage.stage);
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(VisualEvidenceRail, {
						items: [sourceScenes[2], productScenes[1]],
						onOpen: setSelectedVisual,
						compact: true
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DataTable, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "architecture architecture-expanded",
						children: architectureColumns.map((column, index) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 24 }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: column.title }),
									column.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item }, item))
								]
							}), index < architectureColumns.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "technical-proof-grid",
						"aria-label": "기술 구현 검증 계획",
						children: technicalProofs.map((proof) => {
							const Icon = proof.icon;
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "technical-proof-card",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "technical-proof-head",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 22 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: proof.label })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: proof.title }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: proof.text }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: proof.metric }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
										className: "source-link",
										href: proof.href,
										target: "_blank",
										rel: "noreferrer",
										children: ["기술 근거 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { size: 14 })]
									})
								]
							}, proof.title);
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: securityControls.map(([title, text]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WebImageFeature, {
						items: [webVisuals[2], webVisuals[3]],
						compact: true
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "tool-row",
						"aria-label": "주요 사용 기술",
						children: techStack.map((tool) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "tool-icons",
								children: tool.icons.map((icon) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: assetPath(`tech-icons/${icon}`),
									alt: ""
								}, icon))
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: tool.name }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: tool.desc })
						] }, tool.name))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DataTable, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "타임캡슐 해제 로직" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: `IF current_date >= release_date
AND family_admin_confirmed == TRUE
THEN set is_locked = FALSE` }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "잠긴 메시지는 조건 충족 전까지 열람자가 볼 수 없으며, 해제 시점과 확인자는 Audit Log에 남습니다." })
							]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "image-zoom-cue",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Maximize2, { size: 14 }), " 클릭해서 크게 보기"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: pdfAssetPath(productScenes[1].src),
								alt: "미래 기술 대비 장기 보관 구조"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: productScenes[1].label }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: productScenes[1].title }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: productScenes[1].text })
							] })
						]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: revenueStreams.map(([label, title, text], index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							className: "revenue-step",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: title }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text })
							]
						}), index < revenueStreams.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { size: 22 })] }, label))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "business-levers",
						children: businessLevers.map(([label, title, text]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text })
						] }, title))
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "pricing-table expanded-pricing",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "table-head",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "상품" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "과금 방식" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "핵심 제공 가치" })
							]
						}), [
							[
								"Memory Build",
								"1회 구축비",
								"인터뷰 큐레이션, 가족 자료 정리, 사진·음성·영상 아카이브 생성"
							],
							[
								"Premium Capture",
								"고가 패키지",
								"출장 촬영, 3D 입체 초상, 영상 편지, 스토리북 제작"
							],
							[
								"Family Vault",
								"월 구독",
								"암호화 보관, 타임캡슐 알림, 가족 초대, 내보내기"
							],
							[
								"Institution API",
								"라이선스/API",
								"상조·실버타운·요양기관 관리자 콘솔과 API 연동"
							]
						].map(([name, price, description]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "table-row",
							children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WebImageFeature, {
						items: [webVisuals[1], webVisuals[2]],
						compact: true
					})
				]
			}),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fingerprint, { size: 23 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "동의·권한 상태" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "segmented",
								children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
								"현재 공개 범위는 ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: consentMode }),
								"입니다. AI 요약·음성·3D 결과물은 원본과 구분되어 표시됩니다."
							] })
						]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "ethics-grid",
					children: ethics.map(([title, text]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						className: "ethic-card",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { size: 18 }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text })
						]
					}, title))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "ia-grid",
						children: iaCards.map(([title, text]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClipboardCheck, { size: 21 }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text })
						] }, title))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "timeline",
						children: roadmap.map(([phase, period, text], index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							className: "timeline-item",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: phase }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: period }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WebImageFeature, {
						items: [webVisuals[0], webVisuals[3]],
						compact: true
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "closing",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "기술은 인간을 대체하지 않습니다. 인간의 온기를 오래 남기는 도구가 됩니다." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "프로젝트 기억은 개인의 존엄과 가족의 유산을 미래형 데이터 자산으로 보존하는 AI 패밀리 아카이브입니다." })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					className: "primary-action",
					href: "#intro",
					children: ["처음으로 돌아가기 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { size: 18 })]
				})]
			}),
			selectedVisual && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VisualModal, {
				item: selectedVisual,
...
function WebImageFeature({ items, compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: compact ? "web-image-feature compact" : "web-image-feature",
		children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
			className: "web-image-card",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				src: webImagePath(item.src),
				alt: item.title
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
...
function DataTable({ columns, rows }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: column }, column))
		}), rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "data-row",
			children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: cell }, `${cell}-${index}`))
		}, row.join("-")))]
	});
}
function VisualEvidenceRail({ items, onOpen, compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: compact ? "visual-rail visual-rail-compact" : "visual-rail",
		children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VisualCard, {
			item,
			onOpen
		}, item.src))
	});
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: item.title })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function ProductMockup() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mockup",
		"aria-label": "프로젝트 기억 제품 화면 목업",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mockup-sidebar",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Archive, { size: 22 }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {})
			]
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "마이 아카이브" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "consent_status: TRUE" })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "avatar",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: assetPath("giuk-grandmother-avatar.jpg"),
							alt: "인자하게 웃는 할머니"
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "어머니의 오늘, 기억해둘까요?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "3D 캡처 1개, 음성 18개, 사진 126장, 타임캡슐 4개" })] })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "memory-grid",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Images, { size: 20 }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Visual Box" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "사진·영상·3D 초상" })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicVocal, { size: 20 }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Acoustic Box" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "회상 인터뷰 42분" })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { size: 20 }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Narrative Box" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "생애 서사 36개" })
						] })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileAudio, { size: 22 }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "“처음 서울에 올라왔던 날”" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "AI가 요약했지만 원본 음성, 라벨, 접근 로그를 함께 보관합니다." })] }),
...
var root = window.__GIUK_ROOT__ ?? (0, import_client.createRoot)(rootElement);
